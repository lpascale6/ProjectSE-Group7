...
public class CutShapeCommand implements Command{
     ...
     * @param drawingPane the drawing Pane of the selected shape and where to put the copied shape
     */
    ...
    /**
     * method that cuts a shape (saves it in copiedShape of drawingPane and deletes it from the drawingPane).
     * @throws Exception
    */ 
    @Override
